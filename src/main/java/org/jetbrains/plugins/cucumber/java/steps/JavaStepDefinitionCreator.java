...
import org.jetbrains.plugins.cucumber.java.snippet.CamelCaseConcatenator;
import org.jetbrains.plugins.cucumber.java.snippet.FunctionNameGenerator;
import org.jetbrains.plugins.cucumber.java.snippet.SnippetGenerator;
...
//    final Step cucumberStep = new Step(new ArrayList<Comment>(), step.getKeyword().getText(), step.getStepName(), 0, null, null);
    ...
    final PickleStep cucumberStep = new PickleStep(step.getStepName(), args, null, step.getKeyword().getText());
